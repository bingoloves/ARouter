...
public class NewFriendConversation extends Conversation{
    ...
    public int getUnReadCount() {
        return NewFriendManager.getInstance(ChatApp.getApp()).getNewInvitationCount();
    }

    @Override
    public void readAllMessages() {
        //批量更新未读未认证的消息为已读状态
        NewFriendManager.getInstance(ChatApp.getApp()).updateBatchStatus();
    }
