...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    /**
     * 获取当前Holder位置的数据索引
     * @param headerLayoutCount 头部View数量
     * @return
     */
    public int getCurrentPosition(int headerLayoutCount){
        return getLayoutPosition() - headerLayoutCount;
    }
    ...
    public BaseViewHolder addTextChangedListener(@IdRes final int viewId,TextWatcher textWatcher) {
        final View view = getView(viewId);
    ...
    public BaseViewHolder setOnFocusChangeListener(@IdRes final int viewId,View.OnFocusChangeListener focusChangeListener) {
        final View view = getView(viewId);
        if (view != null && view instanceof EditText) {
            EditText editText = (EditText) view;
