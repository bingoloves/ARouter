package cn.cqs.android.utils.log;
...
public class LogPrinterImpl implements LogPrinter {
                ...
                try {
                    ...
                    if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                        ...
                        if (targetFile.length() < 1) {
                            raf.write(getDeviceInfo().getBytes());
                        }
    ...
    public static String getDeviceInfo(){
        ...
        StringBuilder sb = new StringBuilder();
        try {
            PackageInfo packageInfo = pm.getPackageInfo(application.getPackageName(), PackageManager.GET_ACTIVITIES);
